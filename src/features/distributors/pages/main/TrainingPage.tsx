...
export default function TrainingPage(): React.ReactElement {
  ...
  const { data, isLoading, isError } = useMyTrainingModules(page);
    ...
    <div className="flex flex-col gap-6 p-4 sm:p-6 font-[var(--font-bricolage)] text-[#393939] min-h-full bg-white">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
        <div>
          ...
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-[#393939]">Trainings & Modules</h1>
        </div>

        <div className="flex items-center gap-2">
            <span className="hidden md:block text-xs text-stone-400 shrink-0 mr-2">
