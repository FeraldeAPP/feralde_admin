...
import type { Announcement, AnnouncementListData } from '../types';

export async function getAnnouncements(params?: { page?: number; per_page?: number; search?: string }): Promise<ApiResponse<AnnouncementListData>> {
